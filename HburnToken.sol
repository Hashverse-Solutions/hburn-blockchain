...
contract HBurnToken is Context, ERC20, Ownable {
    ...
    constructor(
        ...
        require(_tokenSupply > 0,"HBurnToken: Token supply should be greater than 0");
        tokenSupply = _tokenSupply;
    }

    /// @notice This is a public mintHBurnToken function, this function mints ERC20 token
    ...
    function mintHBurnToken(
        address _account,
        uint256 _amount
    ) public onlyOwner {
        require(_account != address(0),"HBurnToken: Mint address should not be 0");
        require(_amount > 0,"HBurnToken: Mint Amount should be greater than 0");
        uint256 supply = totalSupply();
        require(
            supply + _amount <= tokenSupply,
            "HBurnToken: Mint Amount exceeds total supply"
        );
